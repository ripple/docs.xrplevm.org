...
Welcome to the **XRPL EVM Sidechain**: a high performance, Ethereum compatible blockchain where **XRP** is the native currency, live on **Mainnet**. This section covers everything you need as a user, from setting up your first wallet to bridging assets and exploring the ecosystem.

Ready to jump in? [Get XRP on the XRPL EVM Sidechain](https://app.squidrouter.com/?chains=xrpl-mainnet%2C1440000&tokens=xrp%2C0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee) in a few clicks, or follow the guides below step by step.
...
- [ Ecosystem Map](https://ecosystem.xrplevm.org)
